...
```{r}
#| label: tbl-dinesafe
#| tbl-cap: Number of Establishment Get Pass and Conditional Status in Different Year
#| echo: false

status_severity_by_year <- dinesafe_program_clean |>
  group_by(inspection_year, establishment_status, severity) |>
  summarise(count = n())

```
By the table, it shows there is increase in number of establishments in 2023. It implies more establishments open in 2023 compare to 2022. In this table, it include data in 2024. It is obvious the number of establishments is smaller than 2022 and 2023.  for conditional passed establishment.The decrease is  This fir for the initial hypothesis.
...
status_severity_table <- status_severity_by_year |>
  kable(format = "markdown",
        col.names = c("Year", "Status", "Severity", "Frequency"),
